            ...
            <div>
                  ...
                  <div class="space-y-6">
                    <div class="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="mailto:brian.HLBDG@outlook.com" class="text-gray-600 hover:text-[rgb(211,84,0)] transition-colors">brian.HLBDG@outlook.com</a>
                      </div>
                    </div>
                    ...
                    <div class="flex items-start">
                      ...
                      <div>
                        ...
                        <div class="flex space-x-4">
                          <a href="https://linkedin.com/in/hlbdg/" target="_blank" class="text-gray-600 hover:text-[rgb(211,84,0)] transition-colors">LinkedIn</a>
                          <a href="https://github.com/" target="_blank" class="text-gray-600 hover:text-[rgb(211,84,0)] transition-colors">GitHub</a>
                          <a href="https://www.hlbdesigngroup.com" target="_blank" class="text-gray-600 hover:text-[rgb(211,84,0)] transition-colors">Website</a>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <.form for={@form} phx-submit="submit_form" class="space-y-6" phx-hook="FormValidation">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          <option value="phoenix_liveview">Phoenix LiveView Development</option>
                          <option value="frontend_dev">Frontend Development</option>
              ...
              <div id="availability" class="mt-16 pt-12 border-t border-gray-200" phx-hook="FadeIn">
                ...
                <p class="text-gray-600 mb-4">
                  I'm currently taking on new projects starting <span class="font-medium">April 2025</span>.
                </p>
