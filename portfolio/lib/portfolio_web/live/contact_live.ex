        ...
        <div class="w-full mx-auto px-8 md:px-12 pt-16 flex flex-col md:flex-row">
          <div class="flex-1 md:pr-8 lg:pr-12 pt-12 md:max-w-[75%] lg:max-w-[80%]">
            <div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                  ...
                  <div class="space-y-6">
                    <div class="flex items-start">
                      <div class="w-8 h-8 flex items-center justify-center mr-4 mt-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary dark:text-primary-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                      </div>
                      <div>
                        <h3 class="text-lg font-medium mb-1 dark:text-gray-100">Email</h3>
                        <a href="mailto:your.email@example.com" class="text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary-dark transition-colors">your.email@example.com</a>
                      </div>
                    </div>
                    ...
                    <div class="flex items-start">
                      ...
                      <div>
                        <h3 class="text-lg font-medium mb-1 dark:text-gray-100">Location</h3>
                        <p class="text-gray-600 dark:text-gray-300">Chicago, IL</p>
                      </div>
                    </div>
                    ...
                    <div class="flex items-start">
                      ...
                      <div>
                        <h3 class="text-lg font-medium mb-1 dark:text-gray-100">Social</h3>
                        <div class="flex space-x-4">
                          <a href="https://linkedin.com/" target="_blank" class="text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary-dark transition-colors">LinkedIn</a>
                          <a href="https://twitter.com/" target="_blank" class="text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary-dark transition-colors">Twitter</a>
                          <a href="https://dribbble.com/" target="_blank" class="text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary-dark transition-colors">Dribbble</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div id="contact-form" phx-hook="FadeIn">
                  <%= if @form_submitted do %>
                    <div class="p-6 bg-green-50 dark:bg-green-900 rounded-sm mb-4">
                      <h3 class="text-lg font-medium text-green-800 dark:text-green-200 mb-2">Message sent successfully!</h3>
                    ...
                    <button
                      ...
                      class="text-primary hover:text-[rgb(180,70,0)] dark:text-primary-dark dark:hover:text-[rgb(243,156,18)] transition-colors inline-flex items-center">
                  ...
                  <% else %>
                    <%= if @form_error do %>
                      <div class="p-6 bg-red-50 dark:bg-red-900 rounded-sm mb-4">
                        <h3 class="text-lg font-medium text-red-800 dark:text-red-200 mb-2">Oops! Something went wrong.</h3>
                    ...
                    <.form for={@form} phx-submit="submit_form" class="space-y-6" phx-hook="FormValidation">
                      <div>
                        ...
                        <input
                          ...
                          placeholder="Brian H."
                          required
                          class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-sm focus:ring-primary dark:focus:ring-primary-dark focus:border-primary dark:focus:border-primary-dark outline-none transition-colors bg-white dark:bg-dark-surface text-gray-800 dark:text-gray-200" />
                      </div>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          required
                          class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-sm focus:ring-primary dark:focus:ring-primary-dark focus:border-primary dark:focus:border-primary-dark outline-none transition-colors bg-white dark:bg-dark-surface text-gray-800 dark:text-gray-200"></textarea>
                      </div>

                      <div>
                        <button
                          type="submit"
                          class="px-6 py-3 bg-primary text-white hover:bg-[rgb(180,70,0)] dark:bg-primary-dark dark:hover:bg-[rgb(243,156,18)] transition-colors rounded-sm flex items-center">
                          Send Message
              ...
              <div id="availability" class="mt-16 pt-12 border-t border-gray-200 dark:border-gray-700" phx-hook="FadeIn">
                <h2 class="text-2xl font-light mb-6 dark:text-gray-200">Current Availability</h2>
